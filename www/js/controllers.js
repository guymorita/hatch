...
var LoginCtrl = function($scope, navSvc, $http, userService){
...
var NewMessage = function($scope, navSvc, userService, hatchService, imageService){
  $scope.title = '';
  $scope.content = '';
  $scope.hidden = false;
...
var showPinsCtrl = function($scope, navSvc, userService, $http) {
